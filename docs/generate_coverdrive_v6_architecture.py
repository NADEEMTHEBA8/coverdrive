...
# Perfectly Pixel-Aligned & Symmetrical Vector Architecture Generator for Coverdrive (100% Theme Standard)
svg_template = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2400 1250" width="2400" height="1250" style="background-color: #F8FAFC; font-family: system-ui, -apple-system, 'SF Pro Display', Inter, Roboto, sans-serif;">
  ...
  <g transform="translate(1200, 60)" text-anchor="middle">
    ...
    <text x="0" y="6" text-anchor="middle" class="title-vpc">COVERDRIVE: CRICKET TELEMETRY &amp; ML WIN PROBABILITY (100% VERIFIED CODEBASE ENGINE)</text>
  </g>

  <!-- ==================== COLUMN 1: STEP 1 INGESTION & EVENT STREAMING ==================== -->
  <rect x="68" y="95" width="530" height="885" class="column-box" />
  <text x="333" y="130" text-anchor="middle" class="step-header">STEP 1: INGESTION &amp; EVENT STREAMING</text>

  <!-- Node 1: Kaggle Telemetry -->
  <g transform="translate(88, 160)">
    ...
    <text x="75" y="78" text-anchor="middle" class="node-title">Kaggle Telemetry</text>
    <text x="75" y="101" text-anchor="middle" class="node-subtext">Ball-by-Ball CSV Ingest</text>
  </g>

  <!-- Node 2: DuckDB Ingestion Engine -->
  <g transform="translate(258, 160)">
    <rect width="150" height="135" class="card card-blue" />
    <rect x="40" y="14" width="70" height="38" rx="8" fill="#475569" />
    <text x="75" y="38" text-anchor="middle" font-size="12px" font-weight="900" fill="#FFFFFF">DuckDB</text>
    <text x="75" y="78" text-anchor="middle" class="node-title">DuckDB Ingestion</text>
    <text x="75" y="101" text-anchor="middle" class="node-subtext">High-Speed Relational</text>
  </g>

  <!-- Node 3: Live Match API -->
  <g transform="translate(428, 160)">
    ...
    <text x="75" y="78" text-anchor="middle" class="node-title">Live Match API</text>
    <text x="75" y="101" text-anchor="middle" class="node-subtext">Over-by-Over Feeds</text>
  </g>

  <!-- Bottom Node: PySpark Event Stream Engine -->
  <g transform="translate(168, 365)">
    ...
    <text x="165" y="76" text-anchor="middle" class="node-title" fill="#0073BB">PySpark Stream Engine</text>
    <text x="165" y="100" text-anchor="middle" class="node-title">Micro-Batch Streaming (10s)</text>
    <text x="165" y="122" text-anchor="middle" class="node-subtext">Zero Record Loss Schema Sync</text>
  </g>
  ...
  <!-- ==================== COLUMN 2: STEP 2 MEDALLION BRONZE & QUALITY GUARD ==================== -->
  <rect x="646" y="95" width="530" height="885" class="column-box" />
  <text x="911" y="130" text-anchor="middle" class="step-header">STEP 2: MEDALLION BRONZE &amp; QUALITY GUARD</text>
  ...
  <g transform="translate(666, 160)">
    ...
    <text x="115" y="116" text-anchor="middle" class="node-subtext">s3://.../bronze_cricket</text>
  </g>

  <!-- Top Right: Apache Airflow Orchestrator -->
  <g transform="translate(926, 160)">
    ...
    <text x="115" y="76" text-anchor="middle" class="node-title" fill="#8C4FFF">Airflow Orchestrator</text>
    <text x="115" y="98" text-anchor="middle" class="node-subtext">DAG Orchestration Controller</text>
    <text x="115" y="116" text-anchor="middle" class="node-subtext">Task Execution Pre-Hooks</text>
  </g>
  ...
  <g transform="translate(761, 375)">
    ...
    <text x="150" y="118" text-anchor="middle" class="node-subtext">Null Invariant &amp; Range Gates</text>
  </g>

  <!-- Bottom Box: AWS S3 DLQ Bucket -->
  <g transform="translate(761, 595)">
    ...
    <text x="150" y="96" text-anchor="middle" class="node-title" fill="#991B1B">Quarantine Corrupt Data</text>
    <text x="150" y="114" text-anchor="middle" class="node-subtext">quarantine_cricket Sink</text>
  </g>
  ...
  <!-- ==================== COLUMN 3: STEP 3 COMPUTE & FEATURE STORE ==================== -->
  <rect x="1224" y="95" width="530" height="885" class="column-box" />
  <text x="1489" y="130" text-anchor="middle" class="step-header">STEP 3: COMPUTE &amp; FEATURE STORE</text>

  <!-- Top Left: PySpark Feature Engine -->
  <g transform="translate(1244, 160)">
    ...
    <text x="115" y="76" text-anchor="middle" class="node-title" fill="#FF3600">PySpark Feature Engine</text>
    <text x="115" y="98" text-anchor="middle" class="node-subtext">Rolling Run Rates &amp; PCA</text>
    <text x="115" y="116" text-anchor="middle" class="node-subtext">Partitioned: match_id</text>
  </g>
  ...
  <!-- Middle Node: AWS S3 Silver Lake -->
  <g transform="translate(1324, 375)">
    ...
    <text x="165" y="100" text-anchor="middle" class="node-title">Cleansed Telemetry Matrix</text>
    <text x="165" y="120" text-anchor="middle" class="node-subtext">s3://.../silver_cricket</text>
  </g>
  ...
  <g transform="translate(1324, 575)">
    ...
    <text x="165" y="76" text-anchor="middle" class="node-title" fill="#FF3600">dbt Core 1.8 Engine</text>
    <text x="165" y="100" text-anchor="middle" class="node-title">Dimensional Feature Models</text>
    <text x="165" y="120" text-anchor="middle" class="node-subtext">SCD Type 2 &amp; Data Quality Tests</text>
  </g>
  ...
  <g transform="translate(1324, 775)">
    ...
    <text x="165" y="100" text-anchor="middle" class="node-title">Curated Match Win Marts</text>
    <text x="165" y="120" text-anchor="middle" class="node-subtext">s3://.../gold_win_prediction</text>
  </g>
  ...
  <!-- ==================== COLUMN 4: STEP 4 SERVING & DUAL-TARGET ML SCORING ==================== -->
  <rect x="1802" y="95" width="530" height="885" class="column-box" />
  <text x="2067" y="130" text-anchor="middle" class="step-header">STEP 4: SERVING &amp; DUAL-TARGET ML SCORING</text>

  <!-- Top Node: XGBoost Win Probability Model -->
  <g transform="translate(1897, 160)">
    ...
    <text x="170" y="76" text-anchor="middle" class="node-title" fill="#0073BB">XGBoost Win Probability</text>
    <text x="170" y="100" text-anchor="middle" class="node-title">AUC-ROC: 0.7719 Classifier</text>
    <text x="170" y="118" text-anchor="middle" class="node-subtext">Live Match State Inference Engine</text>
  </g>

  <!-- Middle Node: Multi-Output Classifier -->
  <g transform="translate(1897, 375)">
    ...
    <text x="170" y="76" text-anchor="middle" class="node-title" fill="#07C284">Multi-Output Classifier</text>
    <text x="170" y="100" text-anchor="middle" class="node-title">Runs, Wickets &amp; Win Prob%</text>
    <text x="170" y="118" text-anchor="middle" class="node-subtext">Real-Time In-Game Win Dashboard</text>
  </g>
  ...
  <text x="1802.5" y="677" text-anchor="middle" class="arrow-label" fill="#FF9D00">4. Win Query</text>
...
svg_path = "/Users/nadeemtheba/projects/coverdrive/docs/assets/coverdrive_v4_remediated.svg"
alt_svg_path = "/Users/nadeemtheba/projects/coverdrive/docs/assets/coverdrive_architecture.svg"
...
print("Standardized Coverdrive Vector SVG created successfully!")

# Render Ultra-HD 4K PNG via resvg-py
png_bytes = resvg_py.svg_to_bytes(svg_template, zoom=4.0)

png_path = "/Users/nadeemtheba/projects/coverdrive/docs/assets/coverdrive_v4_remediated.png"
alt_png_path = (
...
print(
    f"Standardized Coverdrive 4K Ultra-HD PNG generated successfully ({len(png_bytes)/1024/1024:.2f} MB)!"
)
